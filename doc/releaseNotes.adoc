...
. Visit https://developers.google.com/doubleclick-publishers/docs/reference/v201411/ActivityGroupService[DFP API documentation] page for information on DFP v201411 API.
